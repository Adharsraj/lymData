  ...
  return (
    ...
    <div className="max-w-[1640px] mx-auto p-4 font-dm ">
      <div className="grid grid-cols-1 md:grid-cols-3 ">
        <div>
          <h1 className="font-mono ml-3 md:py-20 mt-4 mb-4 md:ml-5">
            Industries we know and understand
          </h1>
          <h2 className="text-6xl lg:text-9xl font-bold">
            experi <br />
            ence
          </h2>
          <span className="flex ml-16 w-[40px] h-[1px] b-[1px] t-[5px]  rounded-full py-10">
            <BsArrowDown size={30} />
          </span>
        </div>
        <div>
        ...
        <div>
          <svg
            ...
            viewBox="0 0 60 60"
            fill="none"
            className="  md:w-[200px] md:mt-16 md:ml-5 lg:ml-5 md:flex hover:animate-spin "
          ...
          <h1 className="text-md font-semibold mt-4 mb-4 lg:mt-20 lg:text-2xl font-sans">
            We know what <br />
            we're doing
          </h1>
          <h1 className="text-md lg:mt-12 lg:text-xl font-sans">
    ...
    <img src={viacomLogo} alt="Partners" className="w-14 md:w-16  lg:w-28 h-[100px]" />
  </div>
                </>
  );
};
