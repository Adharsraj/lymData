...
<h4 className='lg:text-[70px] text-[35px] font-bold lg:px-28 text-black px-5 some-element'>Services</h4>
  ...
  <img src={m.img} className='h-[56px] w-full rounded-t-3xl' alt="services" />
