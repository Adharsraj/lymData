...
const Hero = () => {
  return (
    <div className="max-w-[1640px] mx-auto p-2 font-roboto relative bg-neutral-50 mb-20">
      <div>
        <video className="opacity-75 h-[310px] sm:h-full" src={Srotating} autoPlay loop muted></video>
      </div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  text-center">
        <h1 className="text-sm sm:text-lg w-[300px] mt-32  sm:w-[584px] md:text-xxl md:w-[580px] h-[104px]">
