    ...
    <div className="max-w-[1640px]  mx-auto p-4 bg-black text-white font-roboto ">
      <div className="mt-20">
        <h1 className="mb-8 mt-8 text-2xl  md:text-4xl lg:text-5xl  lg:ml-10 md:ml-5 font-times">
          About <span className="text-yellow-300  text-2xl md:text-4xl lg:text-4xl  ">LYM-DATA</span>
        </h1>
      ...
      <div className="flex flex-col justify-center items-center text-center mb-16">
        <h1 className="text-sm text-gray-400 mb-4 md:text-lg lg:text-xl">Our Values</h1>
       ...
       {ourValues.map((m)=>(
        <div key={m.id} className="mb-6 lg:flex  w-[290px] mx-auto md:w-[600px] lg:w-[800px] border-b ">
          <h1 className="mb-6 lg:w-[400px] text-xl ml-2 md:text-2xl ">{m.title}</h1>
