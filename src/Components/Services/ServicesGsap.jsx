    ...
    <div class="scrollContainer">
      ...
      <h1 className="text-3xl md:text-5xl font-bold  md:leading-[60px] pb-10">
          ...
          <div class="process-card">
            <div class="image-wrap">
              <img
                src="https://www.brucira.com/assets/img/services/cards/design.svg"
                alt
                width="96"
                height="125"
              />
          ...
          <div class="process-card">
            <div class="image-wrap">
              <img
                src="https://www.brucira.com/assets/img/services/cards/development.svg"
                alt
                width="108"
                height="111"
              />
            ...
            <h3>Development</h3>
            <p>
              Gears up work with varied frameworks, libraries and
          ...
          <div class="process-card">
            <div class="image-wrap">
              <img
                src="https://www.brucira.com/assets/img/services/cards/testing2.svg"
                alt
                width="108"
                height="105"
              />
          ...
          <div class="process-card">
            <div class="image-wrap">
              <img
                src="https://www.brucira.com/assets/img/services/cards/launch.svg"
                alt
                width="101"
                height="100"
              />
            ...
            <h3>Launch</h3>
            <p>
              Aids in presenting the final products to the market and
          ...
          <div class="process-card">
            <div class="image-wrap">
              <img
                src="https://www.brucira.com/assets/img/services/cards/support2.svg"
                alt
                width="91"
                height="100"
              />
