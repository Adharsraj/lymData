...
const BlogCards = () => {
  ...
  {blogCards.map((m, index) => (
    <div className='w-full lg:w-[300px] lg:mt-10 h-[250px] bg-white hover:bg-gradient-to-r from-cyan-400 to-indigo-400 cursor-pointer lg:hover:w-[325px] rounded-3xl mx-auto shadow-2xl'>
