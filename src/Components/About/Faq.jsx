...
<div className='lg:mx-36 mb-10  '>
         <h1 className=' lg:text-8xl md:text-6xl text-4xl text-center mt-10 '>Frequently Asked </h1>
         <h1 className='lg:text-8xl md:text-6xl text-4xl text-center mb-5 mt-2'> Questions</h1>
      ...
      {accordionData.map((item, index) => (
        <div key={index}>
          ...
          >
            <span className='lg:text-xl md:text-lg text-left font-zuume'>{item.title}</span>
            <svg
