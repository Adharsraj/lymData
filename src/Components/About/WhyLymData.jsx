...
const WhyLymData = () => {
  ...
  <h1 className="text-sm text-gray-400  text-left md:text-lg lg:text-xl md:ml-5 lg:ml-10 mt-6 mb-6">Why LymData</h1>
...
<div className="lg:grid lg:grid-cols-3 gap-6 mx-auto md:text-lg ">
  {whyLymData.map((m) => (
    <div key={m.id} className=" border-slate-200 mb-4 w-[290px] sm:w-[400px]  lg:w-[290px] mx-auto lg:ml-9 ">
