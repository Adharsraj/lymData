  ...
  return (
    <>
        ...
        <div className='mt-32'>
          ...
          <h2 className="mt-5 text-4xl font-times">Privacy Policy</h2>
          <div>
            <h2 className="mt-2 lg:w-[1000px] md:text-lg">
            We are BYND LIMITED of the United Kingdom, a limited company
             whose registered office is at 60 Great Portland Street, 
             London, W1W 7RT. Our registered company number is 07123452. 
             We're also associated with BYND LLC, a limited liability 
             company based in the US. Both companies are trading under 
             the Beyond brand and may provide you with our services.
            </h2>
            <h2 className="mt-2">Last updated: May 2021</h2>
          </div>
          <div className="md:ml-14 md:text-lg lg:w-[950px]">
            <h1 className="mt-4 mb-4">1. Operational logs and statistics</h1>
            ...
            <h1 className="mt-4 mb-4">2. Analytics used for improving our services</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">3. Marketing and promoting our business</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">4. Events</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">5. Day to day business interactions and general administration</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">6. Product research for our clients</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">7. Workshops with our clients</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">8. Technical solutions for our clients</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">9. Information we collect from other sources</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">10. Automated decision-making and profiling</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">11. How long we keep your personal data</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">12. You have the right to a copy of your data</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">13. You have the right to have wrong information corrected</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">14. In some situations, you have the right to have your information deleted</h1>
            <h3 className="mt-4 mb-4 ">
            ...
            <h1 className="mt-4 mb-4">15. Changes to this privacy notice and how to contact us</h1>
            <h3 className="mt-4 mb-4 ">
            We will keep our privacy notice under regular review and changes we make to our privacy notice in the future will be posted on this page and if the changes will have an effect on you or the way we use your personal data we will bring them to your attention where appropriate. <br/>
